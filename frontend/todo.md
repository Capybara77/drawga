...
1.  ластик для текста
2.  очень большой тест ломает соединение (даже после перезагрузки)
3.  тест допилить (чтобы ширина синхронизировалась)
4.  других пользователей бы видеть
5.  линии с шифтом должны рисоваться по прямым
6.  клеточки на фоне
7.  сделать более адекватный зум
8.  рисовать на отдельном канвасе чтобы не лагало
9.  горячие клавиши (настроек)
